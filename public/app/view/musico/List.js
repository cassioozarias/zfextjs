Ext.require(['WSExt.view.Musico.ComboRenderer']);

Ext.define('WSExt.view.Musico.List' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.MusicoList',
    store: 'Musicos',
    title : 'Lista de Musico',
    //selModel: {mode: 'MULTI'},
    ...
    initComponent: function(){
        ...
        this.columns = [
...

            {
                ...
                renderer: Ext.util.Format.comboRenderer(Ext.create('WSExt.view.musico.ComboRenderer'))
