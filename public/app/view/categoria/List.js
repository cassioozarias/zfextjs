Ext.require(['WSExt.view.Categoria.ComboRenderer']);

Ext.define('WSExt.view.Categoria.List' ,{
    ...
    initComponent: function(){
        ...
        this.columns = [
...

            {
                ...
                renderer: Ext.util.Format.comboRenderer(Ext.create('WSExt.view.categoria.ComboRenderer'))
